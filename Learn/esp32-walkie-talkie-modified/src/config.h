...
// WiFi credentials
#define WIFI_SSID << seto-11-mesh >>
#define WIFI_PSWD << tigaseto >>
...
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK GPIO_NUM_4
#define I2S_SPEAKER_SERIAL_DATA GPIO_NUM_15
// Shutdown line if you have this wired up or -1 if you don't
#define I2S_SPEAKER_SD_PIN GPIO_NUM_23

// transmit button
#define GPIO_TRANSMIT_BUTTON GPIO_NUM_22
